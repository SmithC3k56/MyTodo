    ...
    ITenantManagementDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //{
        //    b.ToTable(MyTodoConsts.DbTablePrefix + "YourEntities", MyTodoConsts.DbSchema);
        ...
        builder.Entity<SubTodo>(b =>
        {
            b.ToTable(MyTodoConsts.DbTablePrefix + "SubTodos", MyTodoConsts.DbSchema);
            b.ConfigureByConvention(); 
        ...
        {
            b.ToTable(MyTodoConsts.DbTablePrefix + "AppUsers", MyTodoConsts.DbSchema);
            b.ConfigureByConvention(); 

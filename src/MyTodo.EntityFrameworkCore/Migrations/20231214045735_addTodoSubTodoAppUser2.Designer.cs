...
namespace MyTodo.Migrations
{
    ...
    [Migration("20231214045735_addTodoSubTodoAppUser2")]
    partial class addTodoSubTodoAppUser2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AppUserTodo", b =>
                {
                    ...
                    b.HasKey("UsersId", "todosId");

                    b.HasIndex("todosId");

                    b.ToTable("AppUserTodo");
                });

            modelBuilder.Entity("MyTodo.SubTodos.SubTodo", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppSubTodos", (string)null);
                });

            modelBuilder.Entity("MyTodo.Todos.Todo", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MyTodo.Users.AppUser", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AppUserTodo", b =>
                {
                    b.HasOne("MyTodo.Users.AppUser", null)
                        .WithMany()
                        .HasForeignKey("UsersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MyTodo.Todos.Todo", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MyTodo.SubTodos.SubTodo", b =>
                {
                    b.HasOne("MyTodo.Todos.Todo", "Todo")
                        .WithMany("SubTodos")
